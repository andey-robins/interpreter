...
import (
	...
	"github.com/andey-robins/interpreter/ast"
...
// deviation from the book because !null should not be TRUE in my opinion
// that's a landmine that's just asking to be stepped on
...
func evalMinusPrefixOperator(right object.Object, env *object.Environment) object.Object {
...
func evalBooleanInfixExpression(operator string, left, right object.Object, env *object.Environment) object.Object {
